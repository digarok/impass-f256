...
:chk_a          bit #>INPUT_A
                ...
                asl             ; *8
                tax
                lda ShotSprTbl,x ; enable sprite
                ora #1          ;
                sta ShotSprTbl,x
                lda PlayerXPos
                clc
...
*                 and #%0000_0011
*                 beq :sh1
* :sh0            SPETRIGGERSND PSNDShot1;#0;#00 ; always channel 0 (tone1), currently LR max
*                 bra :chk_done
:sh1            SPETRIGGERSND PSNDShot0;#0;#00 ; always channel 0 (tone1), currently LR max
:chk_done
                rts
